...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2025 at 06:48 AM
...
INSERT INTO `customers` (`id`, `name`, `email`, `password`, `city`) VALUES
(1, 'varshil', 'kukadiyavarshil@gmail.com', '$2y$10$hdSAFAgQswSJ6ea9uZOsrOa2.bG4Pn1o1Vbk8IIdf.OkfT6w0jaQ6', 'Amreli');
...
INSERT INTO `farmers` (`id`, `name`, `email`, `password`, `profile_pic`, `location`, `bio`, `certification_status`, `certification_doc`, `insurance_doc`, `crop_certification`) VALUES
(1, 'arpit', 'arpit@gmail.com', '$2y$10$hiO6SuhmxE2.FrH4jYwzruxUw6p8dp65YTsVlt5IcDyBTdpZM8Nwq', NULL, 'kanpar', 'i am a farmer,i love farmeing.', 'pending', 'IMG_20220904_161153.jpg', 'peakpx.jpg', 'organic');
...
INSERT INTO `orders` (`id`, `customer_id`, `crop_id`, `quantity`, `total_price`, `status`, `order_date`, `advance_payment`, `farmer_id`) VALUES
(1, 1, 1, 100, 10000.00, 'delivered', '2025-06-10 10:23:57', NULL, NULL);
